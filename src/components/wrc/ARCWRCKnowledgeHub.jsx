...
const s = {
  ...
  statsRow: { display:"flex", gap:"24px", marginBottom:"16px", flexWrap:"wrap" },
  ...
  badge: (col) => ({ display:"inline-block", padding:"2px 8px", borderRadius:"3px", fontSize:"0.6rem", background:col+"22", color:col, border:`1px solid ${col}44`, letterSpacing:"0.05em" }),
  insight: { background:"#0F2744", border:"1px solid #1E4A7A", borderRadius:"6px", padding:"12px 16px", fontSize:"0.72rem", color:"#93C5FD", lineHeight:1.6, marginTop:"12px" },
  mapContainer: { position:"relative", background:"#060C18", border:"1px solid #1E293B", borderRadius:"8px", overflow:"hidden" },
  siteTooltip: { position:"fixed", background:"#0F172A", border:"1px solid #38BDF8", borderRadius:"6px", padding:"10px 14px", fontSize:"0.68rem", pointerEvents:"none", zIndex:1000, maxWidth:"220px", color:"#E2E8F0" },
};
